...
class StoreConfigHeader extends StatelessWidget {
  final int currentStep;
  final int totalSteps;
  final ScreenType screenType;
  final Function(int) onStepTap;

  const StoreConfigHeader({
    super.key,
        ...
        children: List.generate(totalSteps * 2 - 1, (index) {
          if (index.isEven) {
            ...
            return GestureDetector(
              ...
              child: _buildStepCircle(context, stepNumber, isDark, l10n),
            );
          } else {
  ...
  Widget _buildStepCircle(BuildContext context, int stepNumber, bool isDark, AppLocalizations l10n) {
